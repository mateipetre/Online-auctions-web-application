...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($new_password_err) && empty($confirm_password_err)){
        // actualizeaza parola unui utilizator cu o noua valoare pt campul respectiv aleasa de acesta
        $sql = "UPDATE participant SET ParolaUtilizator = ? WHERE ParticipantID = ?";
...
<body>
    <div class="wrapper" style="width:300px; margin:100px auto; position: center">
        ...
        <p><i>Completati cele 2 campuri pentru a reseta parola.</i></p>
